      ...
      <form action="saveregister.php" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your number" required name="uphone">
          </div>
          <div class="input-box">
            <span class="details">Password</span>
            <input type="password" placeholder="Enter your password" required name="upassword1">
          </div>
          <div class="input-box">
            <span class="details">Confirm Password</span>
            <input type="password" placeholder="Confirm your password" required name="upassword2">
          </div>
        </div>
        <div class="gender-details">
          <input type="radio" name="ugender" id="dot-1" value="Male">
          <input type="radio" name="ugender" id="dot-2" value="Female">
          <input type="radio" name="ugender" id="dot-3" value="Other">
        ...
        <?php 
        if(isset($_SESSION['pwdwrong'])){
          echo $_SESSION['pwdwrong'];

        }
        if(isset($_SESSION['strong'])){
          echo $_SESSION['strong'];
        }
        ?>
